...
public class Draw_Column extends DrawUtil {
  // 声明椭圆1、2的4个点坐标
  ...
  public boolean onTouchEvent(MotionEvent event) {
    ...
    switch (event.getAction()) {
      ...
      case MotionEvent.ACTION_MOVE:
        ...
        /*
         * 画椭圆与画矩形类似
         * 先确定画矩形1需要的两个点坐标点 oval1Point1、oval1Point2
         */
        oval1Point1.set(downPoint.x, downPoint.y);
        oval1Point2.set(movePoint.x, movePoint.y);

        /*
         * 椭圆1 左边和右边的的坐标点 LeftPoint_oval1、RightPoint_oval1
         */
        ...
        // 计算一个纵坐标需要改变的距离
        int distance = (int) Math.abs(Math.sqrt((oval1Point2.x - oval1Point1.x) * (oval1Point2.x
            - oval1Point1.x) + (oval1Point2.y - oval1Point1.y) * (oval1Point2.y - oval1Point1.y)));

        /*
         * 根据椭圆1画椭圆2
         * 为了使椭圆1与椭圆2上下平行，横坐标不变，改变纵坐标
         *
         * 确定画椭圆2需要的两个点坐标 oval2Point1、oval2Point2
         */
        oval2Point1.set(oval1Point1.x, oval1Point1.y + distance);
        oval2Point2.set(oval1Point2.x, oval1Point2.y + distance);

        /*
         * 椭圆2 左边和右边的的坐标点 LeftPoint_oval2、RightPoint_oval2
         */
        ...
        // 画两条线，将椭圆1和椭圆2连接起来
        canvas.drawLine(LeftPoint_oval1.x, LeftPoint_oval1.y, LeftPoint_oval2.x,
            LeftPoint_oval2.y, paint);
        canvas.drawLine(RightPoint_oval1.x, RightPoint_oval1.y, RightPoint_oval2.x,
            RightPoint_oval2.y, paint);
