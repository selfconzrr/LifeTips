...
public class CustomCrashUtil implements Thread.UncaughtExceptionHandler {
  private static final String TAG = "CustomCrashUtil";
  ...
  private static final String CARSH_LOG_DELIVER = "http://img2.xxh" +
      ".cc:8080/SalesWebTest/CrashDeliver";
  private Context mContext;

  private CustomCrashUtil() {
  }

  public static CustomCrashUtil getInstance() {
    return new CustomCrashUtil();
  }
...
//    stringBuffer.append("SystemVersion:" + StrUtil.getLocalSystemVersion() + "\n");
